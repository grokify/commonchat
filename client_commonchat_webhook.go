...
type Adapter interface {
	SendWebhook(url string, message Message, finalMsg interface{}) (*fasthttp.Request, *fasthttp.Response, error)
	SendMessage(message Message, finalMsg interface{}) (*fasthttp.Request, *fasthttp.Response, error)
